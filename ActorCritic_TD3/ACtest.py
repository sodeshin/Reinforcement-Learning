...
def Evaluation(Eseed,lseed):
    ...
    directory = "./preTrained/actorcritic/{}".format(env_name) # save trained models
...
def percentileplot(ndarray):
    ...
    pname = "ActorCritic.st"+str(num_step)+".png"
...
def main():
    ...
    for i in tqdm(range(5)):#これを全体のループに変更
        ...
        Evalue = Evaluation(i,seed+i)#評価時のseed,読み出すための学習時のseed
